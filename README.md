...
[![Remote API Coverage Status (58/58 endpoints)](http://progressed.io/bar/100?title=api%20coverage)](https://github.com/gesellix/docker-client/blob/master/roadmap.md)
...
Then, you need to add the dependency, but please ensure to use the [latest version](https://bintray.com/gesellix/docker-utils/docker-client/_latestVersion):
    ...
    dependencies {
      compile 'de.gesellix:docker-client:2016-01-11T22-38-52'
    }
